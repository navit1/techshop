    ...
    <div className="space-y-12">
      ...
      <section className="relative bg-gradient-to-r from-primary/70 via-primary/50 to-accent/50 text-primary-foreground py-20 px-6 rounded-lg shadow-xl overflow-hidden">
        <div className="absolute inset-0">
           <Image 
            src="https://picsum.photos/seed/storehero/1200/400" 
        ...
        <div className="relative container mx-auto text-center">
          <h1 className="text-5xl font-extrabold mb-4 tracking-tight">Welcome to E-Commerce Lite</h1>
      ...
      <section>
        <h2 className="text-3xl font-semibold mb-8 text-center text-foreground">Featured Products</h2>
      ...
      <section className="bg-card p-8 rounded-lg shadow-md">
        <div className="text-center">
          <h3 className="text-2xl font-semibold text-primary mb-3">Special Offers This Week!</h3>
          <p className="text-muted-foreground mb-6">
            Don&apos;t miss out on our exclusive deals. Limited time only.
          </p>
          <Button asChild variant="outline">
            <Link href="/products?filter=sale">View Deals</Link>
          </Button>
        </div>
      </section>
